package io.codelirium.blueground.intergalactica.model.dto.response.builder;
...
import static io.codelirium.blueground.intergalactica.model.dto.response.builder.RESTResponseBodyBuilder.ResponseStatus.failure;
import static io.codelirium.blueground.intergalactica.model.dto.response.builder.RESTResponseBodyBuilder.ResponseStatus.success;
...
public final class RESTResponseBodyBuilder {
	...
	public static <T, S> RESTSuccessResponseBody<T> success(final String type, final Collection<T> data, final S pagedSearchDTO) {

		final RESTSuccessResponseBody<T> successBody = success(type, data);

		successBody.setPagedSearchDTO(pagedSearchDTO);
