...
import static io.codelirium.blueground.intergalactica.controller.mapping.UrlMappings.API_ERROR;
...
@ControllerAdvice
public class IntergalacticaErrorHandler extends BasicErrorController {

	private static final Logger LOGGER = getLogger(IntergalacticaErrorHandler.class);
	...
	@Inject
	public IntergalacticaErrorHandler(final ObjectMapper objectMapper) {
	...
	@RequestMapping(value = API_ERROR, produces = APPLICATION_JSON_VALUE)
	...
	@Override
	@ResponseStatus(NOT_FOUND)
	@RequestMapping(value = API_ERROR, produces = TEXT_HTML_VALUE)
	@SuppressWarnings("unchecked")
